...
$(function(){
	$('#nav-plane ul li a,.r_nav a').on('click', function(e){
		...
		$('html, body').animate({scrollTop: top-49}, 100,function(){ dom.stop();});
		e.preventDefault();
	})
});
...
$(function(){
	/*********hover*********/
	$(".box_list>li>div").css("background-color","#666").hide();
	$(".box_list>li").mouseover(function(){
		$(this).children("div").stop().fadeIn(100);
	});
	$(".box_list>li").mouseout(function(){
